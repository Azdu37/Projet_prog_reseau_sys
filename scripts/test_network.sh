...
python3 "$ROOT_DIR/ancien_projet/network_bridge.py" cleanup || true

echo "== Test 1: C -> Python =="
"$ROOT_DIR/c_network/mbai_ipc_test" write-demo
python3 "$ROOT_DIR/ancien_projet/network_bridge.py" read

echo "== Test 2: Python -> C =="
python3 "$ROOT_DIR/ancien_projet/network_bridge.py" write-demo
